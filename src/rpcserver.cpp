...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LKRM features */
        {"lkrm", "masternode", &masternode, true, true, false},
        {"lkrm", "listmasternodes", &listmasternodes, true, true, false},
        {"lkrm", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lkrm", "masternodeconnect", &masternodeconnect, true, true, false},
        {"lkrm", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lkrm", "masternodedebug", &masternodedebug, true, true, false},
        {"lkrm", "startmasternode", &startmasternode, true, true, false},
        {"lkrm", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lkrm", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lkrm", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lkrm", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lkrm", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lkrm", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lkrm", "mnsync", &mnsync, true, true, false},
        {"lkrm", "spork", &spork, true, true, false},
        {"lkrm", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"lkrm", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lkrmd, or the -server option to lkrm-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> lkrm-cli " + methodname + " " + args + "\n";
}
