 ...
 * LKRM system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& LKRMDevKey() const { return vLKRMDevKey; }
    // const std::vector<unsigned char>& LKRMFundKey() const { return vLKRMFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vLKRMDevKey;
    // std::vector<unsigned char> vLKRMFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
