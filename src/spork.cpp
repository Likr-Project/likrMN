...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_8_PROCESS_BLOCK_SPAM_FILTER_ENFORCEMENT) r = SPORK_8_PROCESS_BLOCK_SPAM_FILTER_ENFORCEMENT_DEFAULT;
        if (nSporkID == SPORK_9_ACCEPT_BLOCK_SPAM_FILTER_ENFORCEMENT) r = SPORK_9_ACCEPT_BLOCK_SPAM_FILTER_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_8_PROCESS_BLOCK_SPAM_FILTER_ENFORCEMENT") return SPORK_8_PROCESS_BLOCK_SPAM_FILTER_ENFORCEMENT;
    if (strName == "SPORK_9_ACCEPT_BLOCK_SPAM_FILTER_ENFORCEMENT") return SPORK_9_ACCEPT_BLOCK_SPAM_FILTER_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_8_PROCESS_BLOCK_SPAM_FILTER_ENFORCEMENT) return "SPORK_8_PROCESS_BLOCK_SPAM_FILTER_ENFORCEMENT";
    if (id == SPORK_9_ACCEPT_BLOCK_SPAM_FILTER_ENFORCEMENT) return "SPORK_9_ACCEPT_BLOCK_SPAM_FILTER_ENFORCEMENT";
