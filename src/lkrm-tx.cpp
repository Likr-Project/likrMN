...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LKRM Core lkrm-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lkrm-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded LKRM transaction") + "\n" +
                               "  lkrm-tx [options] -create [commands]   " + _("Create hex-encoded LKRM transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded LKRM transaction
