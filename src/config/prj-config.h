/* src/config/lkrm-config.h.  Generated from lkrm-config.h.in by configure.  */
/* src/config/lkrm-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LKRM_CONFIG_H

#define LKRM_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.likrwallet.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LKRM Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LKRM Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lkrm"
