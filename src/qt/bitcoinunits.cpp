...
// Copyright (c) 2017-2018 The LKRM Core developers
...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(LKRM);
   // unitlist.append(mLKRM);
   // unitlist.append(uLKRM);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case LKRM:
            return QString("tLKRM");
        case mLKRM:
            return QString("mLKRM");
        case uLKRM:
            return QString::fromUtf8("μtLKRM");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case LKRM:
            return QString("LKRM");
        case mLKRM:
            return QString("Milli-LKRM (1 / 1" THIN_SP_UTF8 "000)");
        case uLKRM:
            return QString("Micro-LKRM (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case LKRM:
            return QString("TestLKRMs");
        case mLKRM:
            return QString("Milli-TestLKRMs (1 / 1" THIN_SP_UTF8 "000)");
        case uLKRM:
            return QString("Micro-TestLKRMs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
