...
QFontDatabase::addApplicationFont(":/fonts/lkrm_font");

QString windowTitle = tr("LKRM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LKRM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and LKRM: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LKRM Core"), this);
    aboutAction->setStatusTip(tr("Show information about LKRM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LKRM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LKRM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LKRM addresses"));
    ...
    openAction->setStatusTip(tr("Open a LKRM: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the LKRM Core help message to get a list with possible LKRM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LKRM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LKRM network", "", count));
}
...
{
    QString strTitle = tr("LKRM Core"); // default title
