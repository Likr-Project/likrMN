...
RESOURCES += src/qt/lkrm.qrc src/qt/lkrm_locale.qrc

TRANSLATIONS += src/qt/locale/lkrm_bg.ts \
                src/qt/locale/lkrm_de.ts \
                src/qt/locale/lkrm_en.ts \
                src/qt/locale/lkrm_es.ts \
                src/qt/locale/lkrm_fi.ts \
                src/qt/locale/lkrm_fr.ts \
                src/qt/locale/lkrm_it.ts \
                src/qt/locale/lkrm_ja.ts \
                src/qt/locale/lkrm_pl.ts \
                src/qt/locale/lkrm_pt.ts \
                src/qt/locale/lkrm_ru.ts \
                src/qt/locale/lkrm_sk.ts \
                src/qt/locale/lkrm_sv.ts \
                src/qt/locale/lkrm_vi.ts \
                src/qt/locale/lkrm_zh_CN.ts \
                src/qt/locale/lkrm_zh_TW.ts
