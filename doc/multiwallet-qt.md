...
In order to support loading of multiple wallets in lkrm-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lkrm.cpp.
...
Changes to lkrm.cpp
----------------------
lkrm.cpp is the entry point into lkrm-qt, and as such, will require some minor modifications to provide hooks for
