Contributing to LKRM Core
============================

The LKRM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LKRM Core project, and is not to be
confused with overall LKRM Network Protocol consensus changes.

Whether a pull request is merged into LKRM Core rests with the project merge
...
Patches that change LKRM consensus rules are considerably more involved than
...
Where a patch set proposes to change the LKRM consensus, it must have been
...
The project leader is the release manager for each LKRM Core release.
