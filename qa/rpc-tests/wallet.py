...
#   c) node1 mines 32 blocks, so now node 0 has 60001lkrm, node 1 has 4250lkrm, node2 has none.
#   d) node0 sends 601 lkrm to node2, in two transactions (301 lkrm, then 300 lkrm).
